...
tracks.post('/id', async function(req,res){
    let resultID = await trackDB.getTrackByID(req.body.id);
...
tracks.post('/name', async function(req, res){
    let resultName = await trackDB.getTrackByName(req.body.name);
...
tracks.post('/country', async function(req, res){
   let resultCountry = await trackDB.getTrackByCountry(req.body.country);
