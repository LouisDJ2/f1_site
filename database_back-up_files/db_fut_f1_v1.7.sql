...
INSERT INTO `race_applied` (`unique_ID_applied`, `user_id`, `race_id`, `car`, `pilot1`, `pilot2`, `aero`, `tires`, `confirmed`, `points`) VALUES
(1, 2, 14, 1, 1, 1, 1, 1, 1, 355),
(2, 3, 14, 2, 2, 2, 2, 2, 1, 314),
(3, 4, 14, 3, 3, 3, 3, 3, 1, 256),
(4, 5, 14, 10, 10, 10, 10, 10, 1, 236),
(5, 5, 13, 10, 10, 10, 10, 10, 1, 193),
(6, 4, 13, 10, 10, 10, 10, 10, 1, 193),
(7, 3, 11, 10, 10, 10, 10, 10, 1, 10);
...
--
ALTER TABLE `race_applied`
  MODIFY `unique_ID_applied` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
