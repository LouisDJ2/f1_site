...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 03 dec 2022 om 17:18
...
(2, 'Louis', 'Louis@dj.com', 'Bob2', 1420, 355, 4, 4, ''),
(3, 'Gerard', 'gg@m.be', 'Bob', 1256, 314, 0, 4, ''),
(4, 'Peter', 'gg@m.be', 'Bob', 1024, 256, 0, 4, ''),
(5, 'Joris', 'gg@m.be', 'Bob', 944, 236, 0, 4, '');
...
--
ALTER TABLE `race_admins`
  MODIFY `unique_ID_admin` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `race_admins`
  ADD CONSTRAINT `race_relation_admin` FOREIGN KEY (`race_id`) REFERENCES `race` (`unique_ID_race`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `user_relation_admin` FOREIGN KEY (`user_id`) REFERENCES `users` (`unique_ID_user`) ON DELETE SET NULL ON UPDATE SET NULL;
