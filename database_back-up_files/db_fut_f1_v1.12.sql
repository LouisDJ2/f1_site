...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 08 dec 2022 om 14:20
...
(14, 'testrace22', 4, 21, '9999-12-31 23:59:59', 2, 2, 10, 4),
(15, 'to delete 1', 10, 14, '9999-12-31 23:59:59', 2, 1, 10, 4),
(22, 'to delete 7', 10, 22, '9999-12-31 23:59:59', NULL, 1, 10, 4);

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `race_admins`
--

CREATE TABLE `race_admins` (
  `unique_ID_admin` int(11) NOT NULL,
  `race_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Gegevens worden geëxporteerd voor tabel `race_admins`
--

INSERT INTO `race_admins` (`unique_ID_admin`, `race_id`, `user_id`) VALUES
(1, 15, 2),
(13, 22, 1);
...
(17, 2, 15, 1, 1, 1, 1, 1, 1, 208, 1),
(18, 3, 15, 1, 1, 1, 1, 1, 1, 208, 2),
(19, 4, 15, 1, 1, 1, 1, 1, 1, 208, 3),
(20, 5, 15, 1, 1, 1, 1, 1, 1, 208, 4);
...
(1, 'Robin', 'RH', 'Robin123', 1228, 307, 0, 4, ''),
(2, 'Louis', 'Louis@dj.com', 'Bob2', 1628, 208, 5, 5, 'admin_level'),
(3, 'Gerard', 'gg@m.be', 'Bob', 1464, 208, 0, 5, ''),
(4, 'Peter', 'gg@m.be', 'Bob', 1232, 208, 0, 5, ''),
(5, 'Joris', 'gg@m.be', 'Bob', 1152, 208, 0, 5, '');
...
--
-- Indexen voor tabel `race_admins`
--
ALTER TABLE `race_admins`
  ADD PRIMARY KEY (`unique_ID_admin`),
  ADD KEY `race_relation_admin` (`race_id`),
  ADD KEY `user_relation_admin` (`user_id`);
...
--
ALTER TABLE `race`
  MODIFY `unique_ID_race` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT voor een tabel `race_admins`
--
ALTER TABLE `race_admins`
  MODIFY `unique_ID_admin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT voor een tabel `race_applied`
--
ALTER TABLE `race_applied`
  MODIFY `unique_ID_applied` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
-- Beperkingen voor tabel `race_admins`
--
ALTER TABLE `race_admins`
  ADD CONSTRAINT `race_relation_admin` FOREIGN KEY (`race_id`) REFERENCES `race` (`unique_ID_race`) ON DELETE CASCADE ON UPDATE SET NULL,
  ADD CONSTRAINT `user_relation_admin` FOREIGN KEY (`user_id`) REFERENCES `users` (`unique_ID_user`) ON DELETE CASCADE ON UPDATE SET NULL;
...
ALTER TABLE `race_applied`
  ...
  ADD CONSTRAINT `race_relation` FOREIGN KEY (`race_id`) REFERENCES `race` (`unique_ID_race`) ON DELETE CASCADE ON UPDATE CASCADE,
