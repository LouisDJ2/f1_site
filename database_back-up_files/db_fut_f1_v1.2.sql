...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 31 okt 2022 om 13:53
...
INSERT INTO `aero` (`unique_ID_aero`, `brand`, `rating`) VALUES
(1, 'Red Bull', 90);
...
CREATE TABLE `conditions` (
  ...
  `rain_expected` int(11) NOT NULL,
  `rain` int(11) NOT NULL,
  `sun_expected` int(11) NOT NULL,
  `sun` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `aero`
  MODIFY `unique_ID_aero` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `conditions`
  MODIFY `unique_ID_conditions` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tires`
  MODIFY `unique_ID_tire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `race`
  ADD CONSTRAINT `condition_relation` FOREIGN KEY (`winner`) REFERENCES `conditions` (`unique_ID_conditions`) ON DELETE SET NULL ON UPDATE SET NULL,
