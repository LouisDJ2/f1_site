...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 22 okt 2022 om 22:29
...
--
ALTER TABLE `aero`
  MODIFY `unique_ID_aero` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT voor een tabel `cars`
--
ALTER TABLE `cars`
  MODIFY `unique_ID_car` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tires`
  MODIFY `unique_ID_tire` int(11) NOT NULL AUTO_INCREMENT;
